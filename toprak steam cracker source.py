...
Lütfen bu yazılımı yalnızca **etik ve yasal sınırlar içinde** kullanınız.""",
        ...
        "success": "Başarılı",
        "hid_removed_success": "dwmapi.dll başarıyla kaldırıldı!\nSteam'i yeniden başlatabilirsiniz.",
        "hid_removed_status": "✅ dwmapi.dll BAŞARIYLA KALDIRILDI",
        "info": "Bilgi",
        "hid_not_found": "dwmapi.dll dosyası bulunamadı!",
        "hid_not_found_status": "ℹ️ dwmapi.dll BULUNAMADI",
        "error": "Hata",
        "hid_remove_error": "dwmapi.dll kaldırılırken hata oluştu:\n{error}",
        "hid_remove_error_status": "❌ dwmapi.dll KALDIRILAMADI",
        "remove_hid_btn": "🗑️ dwmapi.dll Kaldır",
        ...
        "download_hid_btn": "💾 dwmapi.dll İndir",
        ...
        "dll_download_success_status": "✅ dwmapi.dll BAŞARIYLA İNDİRİLDİ",
        "dll_download_error": "DLL indirilirken hata oluştu:\n{error}",
        "dll_download_error_status": "❌ dwmapi.dll İNDİRİLEMEDİ",
...
""",
        ...
        "success": "Success",
        "hid_removed_success": "dwmapi.dll has been successfully removed!\nYou can restart Steam.",
        "hid_removed_status": "✅ dwmapi.dll REMOVED SUCCESSFULLY",
        "info": "Info",
        "hid_not_found": "dwmapi.dll file not found!",
        "hid_not_found_status": "ℹ️ dwmapi.dll NOT FOUND",
        "error": "Error",
        "hid_remove_error": "An error occurred while removing dwmapi.dll:\n{error}",
        "hid_remove_error_status": "❌ FAILED TO REMOVE dwmapi.dll",
        "remove_hid_btn": "🗑️ Remove dwmapi.dll",
        ...
        "download_hid_btn": "💾 Download dwmapi.dll",
        ...
        "dll_download_success_status": "✅ dwmapi.dll DOWNLOADED SUCCESSFULLY",
        "dll_download_error": "An error occurred while downloading the DLL:\n{error}",
        "dll_download_error_status": "❌ FAILED TO DOWNLOAD dwmapi.dll",
...
class SteamManifestTool:
    ...
    def remove_hid_dll(self):
        try:
            ...
            with winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, "SOFTWARE\\WOW6432Node\\Valve\\Steam") as key:
                ...
                dll_path = os.path.join(steam_path, "dwmapi.dll")
    ...
    def download_hid_dll(self):
        ...
        save_path = os.path.join(steam_path, "dwmapi.dll") if steam_path else os.path.join(os.path.expanduser("~"), "Desktop", "dwmapi.dll")

        if not steam_path:
            messagebox.showwarning(self.strings['warning'], self.strings['hid_path_not_found_warning'])

        try:
            url = "https://raw.githubusercontent.com/toprak1224/hid.dll/refs/heads/main/dwmapi.dll"
